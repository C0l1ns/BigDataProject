...
def populate_context(spark, context):
    ...
    context["name_basics"] = load_dataframe(spark, NAME_BASICS_SCHEMA, "name_basics.tsv")
    ...
    context["title_basics"] = load_dataframe(spark, TITLE_BASICS_SCHEMA, "title_basics.tsv")
